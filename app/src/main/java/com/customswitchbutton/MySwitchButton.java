...
public class MySwitchButton extends View implements Checkable{
    ...
    private static final int DEFAULT_SPOT_ON_COLOR = Color.GREEN;
    private static final int DEFAULT_SPOT_ON_COLOR_IN = Color.GREEN;
    private static final int DEFAULT_SPOT_OFF_COLOR = Color.RED;
    private static final int DEFAULT_SPOT_OFF_COLOR_IN = Color.RED;
